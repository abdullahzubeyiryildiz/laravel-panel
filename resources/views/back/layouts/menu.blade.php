    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">İş Takip</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2) == "urunler") show @endif " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  @if(Request::segment(2) == "urunler" and !Request::segment(3) == "olustur") active @endif " href="{{route('admin.urunler.index')}}">Tüm Ürünler</a>
                        <a class="collapse-item @if(Request::segment(2) == "urunler" and Request::segment(3) == "olustur") active @endif " href="{{route('admin.urunler.create')}}">Ürün Ekle</a>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="fas fa-download fa-sm text-white-50"></i> Siteyi Görüntüle</a>
                    </div>
